...
public class RuneTableMenu extends AbstractContainerMenu {
    ...
    public RuneTableMenu(int pContainerId, Inventory inv, BlockEntity entity) {
        super(ModMenuTypes.RUNE_TABLE_MENU.get(), pContainerId);
        checkContainerSize(inv, 4);
        blockEntity = ((RuneTableEntity) entity);
    ...
    // For this container, we can see both the tile inventory's slots as after as the player inventory slots and the hotbar.
