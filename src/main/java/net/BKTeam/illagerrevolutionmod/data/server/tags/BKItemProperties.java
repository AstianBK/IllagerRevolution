    ...
    public static void register() {
        ...
        ItemProperties.register(ModItems.ILLAGIUM_CROSSBOW.get(), new ResourceLocation(IllagerRevolutionMod.MOD_ID, "pull"), (p_239427_0_, p_239427_1_, p_239427_2_, intIn) -> {
            if (p_239427_2_ == null) {
                ...
                return IllagiumCrossbowItem.isCharged(p_239427_0_) ? 0.0F : (float)(p_239427_0_.getUseDuration() - p_239427_2_.getUseItemRemainingTicks()) / (float)IllagiumCrossbowItem.getChargeDuration(p_239427_0_);
            }
        });
