...
public class BKFireSoulParticles extends TextureSheetParticle {
    private final SpriteSet sprites;

    public BKFireSoulParticles(ClientLevel world, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed, SpriteSet sprites) {
    ...
    public static class Factory implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType type, ClientLevel world, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            return new BKFireSoulParticles(world, x, y, z, xSpeed, ySpeed, zSpeed, this.spriteSet);
        }
    }
}
