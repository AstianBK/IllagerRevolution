...
public class SoulSageRenderer extends ExtendedGeoEntityRenderer<SoulSageEntity> {
    ...
    @Nullable
    @Override
    protected ResourceLocation getTextureForBone(String boneName, SoulSageEntity currentEntity) {
        return null;
    }

    @Nullable
    @Override
    protected ItemStack getHeldItemForBone(String boneName, SoulSageEntity currentEntity) {
        switch (boneName) {
    ...
    @Nullable
    @Override
    protected BlockState getHeldBlockForBone(String boneName, SoulSageEntity currentEntity) {
        return null;

    }

    @Override
    protected void preRenderItem(PoseStack stack, ItemStack item, String boneName, SoulSageEntity currentEntity, IBone bone) {
        
    }

    @Override
    protected void preRenderBlock(PoseStack matrixStack, BlockState block, String boneName, SoulSageEntity currentEntity) {
    }

    @Override
    protected void postRenderItem(PoseStack stack, ItemStack item, String boneName, SoulSageEntity currentEntity, IBone bone) {
    }

    @Override
    protected void postRenderBlock(PoseStack matrixStack, BlockState block, String boneName, SoulSageEntity currentEntity) {
    ...
    @Override
    public RenderType getRenderType(SoulSageEntity animatable, float partialTicks, PoseStack stack,
