...
public class BladeKnightModel<I extends AbstractIllager> extends AnimatedGeoModel<BladeKnightEntity> {
    ...
    @Override
    public ResourceLocation getModelLocation(BladeKnightEntity object) {
        return MODEL_RESLOC;
    }

    @Override
    public ResourceLocation getTextureLocation(BladeKnightEntity object) {
    ...
    @Override
    public ResourceLocation getAnimationFileLocation(BladeKnightEntity animatable) {
