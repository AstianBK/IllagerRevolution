...
public class SoulSageModel<I extends AbstractIllager> extends AnimatedGeoModel<SoulSageEntity> {
    ...
    @Override
    public ResourceLocation getModelLocation(SoulSageEntity object) {
        return MODEL_RESLOC;
    }

    @Override
    public ResourceLocation getTextureLocation(SoulSageEntity object) {
        return TEXTURE_DEFAULT;
    }

    @Override
    public ResourceLocation getAnimationFileLocation(SoulSageEntity animatable) {
