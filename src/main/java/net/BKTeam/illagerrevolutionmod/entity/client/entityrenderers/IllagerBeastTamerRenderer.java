...
public class IllagerBeastTamerRenderer extends ExtendedGeoEntityRenderer<IllagerBeastTamerEntity> {
    ...
    public IllagerBeastTamerRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager,
                new IllagerBeastTamerModel<IllagerBeastTamerEntity>(MODEL_RESLOC, TEXTURE, "illagerbeasttamer"));
