...
public class SoulHunter extends ThrowableItemProjectile {
    ...
    public SoulHunter(EntityType<? extends SoulHunter> type, Level world) {
        super(type,world);
        this.setNoGravity(true);
        this.life=0;
    }

    public SoulHunter(LivingEntity thrower, Level level) {
        super(ModEntityTypes.SOUL_HUNTER.get(),thrower,level);
        this.setNoGravity(true);
        this.life=0;
    }
    public SoulHunter(Level world, double x, double y, double z) {
