...
public class SoulBomb extends ProjectileMagic {
        ...
        if(this.discardMoment){
            ...
            if(this.discardTimer>8){
                ...
                for(LivingEntity living : livings){
                    ...
                    living.hurt(damageSources().indirectMagic(this, owner),5.0F+1.0F*this.getPowerLevel());
                    if(!this.level().isClientSide){
    ...
    protected void onHitEntity(EntityHitResult pResult) {
        ...
        if (pResult.getEntity() instanceof LivingEntity initialTarget) {
            ...
            initialTarget.hurt(damageSources().indirectMagic(this,this.getOwner()),5.0F+1.0F*this.getPowerLevel());
        }
    }
