...
public class Soul_ProjectileItem extends Item {
    public Soul_ProjectileItem(Properties pProperties) {
        super(pProperties);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level pLevel, Player pPlayer, InteractionHand pHand) {
        ...
        if (!pLevel.isClientSide) {
            Soul_Projectile Projectile = new Soul_Projectile(pPlayer,pLevel,pPlayer);
