...
public class ModCreativeModeTab {
    ...
    public static void PreOrdenInit(){
        List<Item> itemList= Arrays.asList(ModItems.BLADE_KNIGHT_SPAWN_EGG.get(),ModItems.ILLAGERBEASTTAMER_SPAWN_EGG.get(),ModItems.ILLAGERMINERBADLANDS_SPAWN_EGG.get(),ModItems.ILLAGERMINER_SPAWN_EGG.get(),
                ...
                ModItems.ILLAGIUM_ALT_RUNED_BLADE.get(),ModItems.JUNK_AXE.get(),ModItems.SCRAPPER_ARMOR_IRON.get(),ModItems.SCRAPPER_ARMOR_GOLD.get(),ModItems.SCRAPPER_ARMOR_DIAMOND.get(),ModItems.SCRAPPER_ARMOR_NETHERITE.get(),ModItems.SCRAPPER_ARMOR_ILLAGIUM.get(),
