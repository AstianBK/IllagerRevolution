...
public class ModCreativeModeTab {
    ...
    public static void PreOrdenInit(){
        List<Item> itemList= Arrays.asList(ModItems.BLADE_KNIGHT_SPAWN_EGG.get(),ModItems.ILLAGERBEASTTAMER_SPAWN_EGG.get(),ModItems.ILLAGERMINERBADLANDS_SPAWN_EGG.get(),ModItems.ILLAGERMINER_SPAWN_EGG.get(),ModItems.WILD_RAVAGER_SPAWN_EGG.get(),ModItems.MAULER_SPAWN_EGG.get(),ModItems.SCROUNGER_SPAWN_EGG.get(),
                ModItems.RAKER_SPAWN_EGG.get(),ModItems.ILLAGIUM.get(),ModItems.ENCRUSTED_LAPIS.get(),ModItems.RAKER_CLAW.get(),ModItems.BEAST_STAFF.get(),ModItems.MAULER_PELT.get(), ModItems.SCROUNGER_FEATHER.get(),
                ...
                ModItems.ILLAGIUM_ALT_RUNED_BLADE.get(),ModItems.SCROUNGER_POUCH.get(),ModItems.RAKER_ARMOR_IRON.get(),ModItems.RAKER_ARMOR_GOLD.get(),ModItems.RAKER_ARMOR_DIAMOND.get(),ModItems.RAKER_ARMOR_NETHERITE.get(),ModItems.RAKER_ARMOR_ILLAGIUM.get(),
