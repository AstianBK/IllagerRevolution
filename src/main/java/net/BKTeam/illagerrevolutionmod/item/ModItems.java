...
public class ModItems {
    ...
    public static final RegistryObject<Item> WILD_RAVAGER_ARMOR_ILLAGIUM = ITEMS.register("wild_ravager_armor_illagium",()->
            new BeastArmorItem(new Item.Properties().durability(1550),20,ModArmorMaterials.ILLAGIUM,0.0d,0,EquipmentSlot.LEGS,Beast.WILD_RAVAGER));

    public static final RegistryObject<Item> WILD_RAVAGER_ARMOR_NETHERITE = ITEMS.register("wild_ravager_armor_netherite",()->
            new BeastArmorItem(new Item.Properties().durability(800),30,ArmorMaterials.NETHERITE,0.0d,0,EquipmentSlot.LEGS,Beast.WILD_RAVAGER));

    public static final RegistryObject<Item> WILD_RAVAGER_ARMOR_DIAMOND = ITEMS.register("wild_ravager_armor_diamond",()->
            new BeastArmorItem(new Item.Properties().durability(750),25,ArmorMaterials.DIAMOND,0.0d,0,EquipmentSlot.LEGS,Beast.WILD_RAVAGER));

    public static final RegistryObject<Item> WILD_RAVAGER_ARMOR_GOLD = ITEMS.register("wild_ravager_armor_gold",()->
            new BeastArmorItem(new Item.Properties().durability(350),10,ArmorMaterials.GOLD,0.0d,0,EquipmentSlot.LEGS,Beast.WILD_RAVAGER));

    public static final RegistryObject<Item> WILD_RAVAGER_ARMOR_IRON = ITEMS.register("wild_ravager_armor_iron",()->
            new BeastArmorItem(new Item.Properties().durability(500),15,ArmorMaterials.IRON,0.0d,0,EquipmentSlot.LEGS,Beast.WILD_RAVAGER));

    public static final RegistryObject<Item> MAULER_ARMOR_ILLAGIUM = ITEMS.register("mauler_armor_illagium",()->
            new BeastArmorItem(new Item.Properties().durability(1550),20,ModArmorMaterials.ILLAGIUM,0.0d,0,EquipmentSlot.LEGS,Beast.MAULER));

    public static final RegistryObject<Item> MAULER_ARMOR_NETHERITE = ITEMS.register("mauler_armor_netherite",()->
            new BeastArmorItem(new Item.Properties().durability(800),30,ArmorMaterials.NETHERITE,0.0d,0,EquipmentSlot.LEGS,Beast.MAULER));

    public static final RegistryObject<Item> MAULER_ARMOR_DIAMOND = ITEMS.register("mauler_armor_diamond",()->
            new BeastArmorItem(new Item.Properties().durability(750),25,ArmorMaterials.DIAMOND,0.0d,0,EquipmentSlot.LEGS,Beast.MAULER));

    public static final RegistryObject<Item> MAULER_ARMOR_GOLD = ITEMS.register("mauler_armor_gold",()->
            new BeastArmorItem(new Item.Properties().durability(350),5,ArmorMaterials.GOLD,0.0d,0,EquipmentSlot.LEGS,Beast.MAULER));

    public static final RegistryObject<Item> MAULER_ARMOR_IRON = ITEMS.register("mauler_armor_iron",()->
            new BeastArmorItem(new Item.Properties().durability(500),10,ArmorMaterials.IRON,0.0d,0,EquipmentSlot.LEGS,Beast.MAULER));

    public static final RegistryObject<Item> RAKER_ARMOR_ILLAGIUM = ITEMS.register("scrapper_armor_illagium",()->
            new BeastArmorItem(new Item.Properties().durability(1550),20,ModArmorMaterials.ILLAGIUM,0.0d,0,EquipmentSlot.FEET,Beast.RAKER));

    public static final RegistryObject<Item> RAKER_ARMOR_NETHERITE = ITEMS.register("scrapper_armor_netherite",()->
            new BeastArmorItem(new Item.Properties().durability(800),30,ArmorMaterials.NETHERITE,0.0d,0,EquipmentSlot.FEET,Beast.RAKER));

    public static final RegistryObject<Item> RAKER_ARMOR_DIAMOND = ITEMS.register("scrapper_armor_diamond",()->
            new BeastArmorItem(new Item.Properties().durability(750),25,ArmorMaterials.DIAMOND,0.0d,0,EquipmentSlot.FEET,Beast.RAKER));

    public static final RegistryObject<Item> RAKER_ARMOR_GOLD = ITEMS.register("scrapper_armor_gold",()->
            new BeastArmorItem(new Item.Properties().durability(350),5,ArmorMaterials.GOLD,0.0d,0,EquipmentSlot.FEET,Beast.RAKER));

    public static final RegistryObject<Item> RAKER_ARMOR_IRON = ITEMS.register("scrapper_armor_iron",()->
            new BeastArmorItem(new Item.Properties().durability(500),10,ArmorMaterials.IRON,0.0d,0,EquipmentSlot.FEET,Beast.RAKER));


    public static final RegistryObject<Item> SCROUNGER_POUCH = ITEMS.register("scrounger_pouch",()->
            new BeastArmorItem(new Item.Properties().durability(200),0,ArmorMaterials.LEATHER,0.0d,0,EquipmentSlot.CHEST,Beast.SCROUNGER));


    public static final RegistryObject<Item> CLAWS_ARMOR_ILLAGIUM = ITEMS.register("claws_armor_illagium",()->
            new BeastArmorItem(new Item.Properties().durability(1500),0,ModArmorMaterials.ILLAGIUM,0.5d,30,EquipmentSlot.LEGS,Beast.RAKER));

    public static final RegistryObject<Item> CLAWS_ARMOR_NETHERITE = ITEMS.register("claws_armor_netherite",()->
            new BeastArmorItem(new Item.Properties().durability(500),0,ArmorMaterials.NETHERITE,0.7d,30,EquipmentSlot.LEGS,Beast.RAKER));

    public static final RegistryObject<Item> CLAWS_ARMOR_DIAMOND = ITEMS.register("claws_armor_diamond",()->
            new BeastArmorItem(new Item.Properties().durability(450),0,ArmorMaterials.DIAMOND,0.6d,30,EquipmentSlot.LEGS,Beast.RAKER));

    public static final RegistryObject<Item> CLAWS_ARMOR_GOLD = ITEMS.register("claws_armor_gold",()->
            new BeastArmorItem(new Item.Properties().durability(100),0,ArmorMaterials.GOLD,0.2d,60,EquipmentSlot.LEGS,Beast.RAKER));

    public static final RegistryObject<Item> CLAWS_ARMOR_IRON = ITEMS.register("claws_armor_iron",()->
            new BeastArmorItem(new Item.Properties().durability(200),0,ArmorMaterials.IRON,0.3d,30,EquipmentSlot.LEGS,Beast.RAKER));
    ...
    public static final RegistryObject<Item> ILLAGIUM_CROSSBOW = ITEMS.register("illagium_crossbow",
            ()->new IllagiumCrossbowItem(new Item.Properties().stacksTo(1).durability(1000)));
