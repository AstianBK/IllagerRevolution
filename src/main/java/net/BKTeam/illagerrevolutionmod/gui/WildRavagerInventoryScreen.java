...
public class WildRavagerInventoryScreen extends AbstractContainerScreen<WildRavagerInventoryMenu>{
    ...
    public WildRavagerInventoryScreen(WildRavagerInventoryMenu pMenu, Inventory pPlayerInventory, WildRavagerEntity pRaker) {
        super(pMenu, pPlayerInventory, Component.nullToEmpty("Wild Ravager Inventory"));
        this.raker = pRaker;
    ...
    protected void renderBg(PoseStack pPoseStack, float pPartialTick, int pX, int pY) {
        ...
        if (this.raker.isTame()) {
            this.blit(pPoseStack, i + 7, j + 53, 54, this.imageHeight + 36, 18, 18);
