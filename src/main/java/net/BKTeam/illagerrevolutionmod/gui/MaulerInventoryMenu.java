...
public class MaulerInventoryMenu extends AbstractContainerMenu {
    private final Container maulerContainer;
    private final MaulerEntity mauler;

    public MaulerInventoryMenu(int p_39656_, Inventory p_39657_, Container p_39658_, final MaulerEntity p_39659_) {
        ...
        this.addSlot(new Slot(p_39658_, 1, 8, 54) {
            public boolean mayPlace(ItemStack p_39690_) {
                return p_39690_.getItem() instanceof BeastArmorItem maulerArmorItem && maulerArmorItem.getEquipmetSlot().equals(EquipmentSlot.LEGS) && maulerArmorItem.getName().equals("mauler");
            }
            public boolean isActive() {
                return true;
            }
