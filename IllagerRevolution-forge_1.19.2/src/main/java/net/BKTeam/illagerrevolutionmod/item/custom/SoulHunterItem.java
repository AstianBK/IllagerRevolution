...
public class SoulHunterItem extends Item {

    public SoulHunterItem(Properties pProperties) {
        super(pProperties);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level pLevel, Player pPlayer, InteractionHand pHand) {
        ...
        if (!pLevel.isClientSide) {
            FallenKnightEntity knight = new FallenKnightEntity(ModEntityTypes.FALLEN_KNIGHT.get(),pLevel);
