...
public class SoulProjectileItem extends Item {
    public SoulProjectileItem(Properties pProperties) {
        super(pProperties);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level pLevel, Player pPlayer, InteractionHand pHand) {
        ...
        if (!pLevel.isClientSide) {
            SoulProjectile Projectile = new SoulProjectile(pPlayer,pLevel,pPlayer);
